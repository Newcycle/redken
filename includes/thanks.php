	...
	<div class="block" style="margin-top: 45px;">
		<div id="thanks-bottom" class="block mt135 center">
			...
			<div class="center-div" style="height: 30px;margin: 35px auto 10px;width: 398px;">
				...
				<a href="https://twitter.com/intent/tweet?status=I've just entered to win Redken's new in-salon Smooth Lock service at Supercuts http://on.fb.me/UC7iI6" target="_blank" ><img id="twitter-share" class="left" src="imgs/twitter_share.png" /> </a>
			</div>
