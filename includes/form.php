...
<div id="form">
		...
		<div class="block">
			<div class="left" style="width:300px;">
				...
				<div class="block">
					...
					<ol class="text white">
						<li>Get half the code by liking Redken's Facebook page</li>
						<li>Get the second half of the code by liking Supercuts' Facebook page</li>
	...
	<div class="block">
		<form id="form-codes" class="block" action="#" method="post">
			<input type="text" disabled="disabled" id="code_redken" class="code" name="code_redken" value="<?php echo $_SESSION["user_redken_code"];?>" />
			<input type="text" id="code_supercut" class="code" name="code_supercut" value="<?php echo $_SESSION["user_supercut_code"];?>" />
			<input type="button" id="btn_submit_code" class="btn-brown right" onClick="top.window.location = '<?php echo $canvas_supercut_page;?>';" value="Get Supercuts code" />
		</form>
	</div>
		...
		<div class="block bg-brown" style="height:510px;" >
			...
			<script>
				...
				$("#choice_location_1").change(function(){
					checkChoicesLocation(1);
				});
				$("#choice_location_2").change(function(){
					checkChoicesLocation(2);
				});
				$("#choice_location_3").change(function(){
					checkChoicesLocation(3);
				});
